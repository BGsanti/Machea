...
localidad (y barrio) quiere estar, qué zonas comunes le importan— y Machea le devuelve
...
años de pago y alcanzabilidad del top—. Ver [CLAUDE.md §4.5](CLAUDE.md).
...
distancia típica de su salto de localidad. Ver [CLAUDE.md §3](CLAUDE.md).
