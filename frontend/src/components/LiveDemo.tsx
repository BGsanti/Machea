...
// despliegue queda en el mismo origen que la landing: un solo proyecto,
// sin variable de entorno que configurar y sin un segundo dominio que pueda
// caducar por su cuenta.
//
// SE NOMBRA `index.html`, no el directorio. Con `/experiencia/` a secas, en
// `npm run dev` Vite trata la ruta sin extension como navegacion SPA y
// devuelve ESTE `index.html` (el de la landing) — el iframe carga la landing
// dentro de si misma en vez del quiz. Mismo motivo que documenta
// `frontend/index.html` del propio bundle de la experiencia.
//
// `marca=machea` es el tenant NEUTRO. Los otros cuatro son de una
...
export function LiveDemo() {
  ...
  return (
    <section id="pruebalo" className="relative overflow-hidden bg-beige py-24">
